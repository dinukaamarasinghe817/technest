...
function ProductCard({ product }) {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <a href="#">
            <img className="mx-auto h-full dark:hidden" src={product.imagePath} alt="" />
        </a>
        </div>
        <div className="pt-6">
            ...
            <div className="mt-2 flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-gray-500">({product.totalNumberOfOrders})</p>
            </div>

            <div className="mt-4 flex items-center justify-between gap-4">
                <p className="text-2xl font-extrabold leading-tight text-gray-900">${product.price.toLocaleString()}</p>

                <button type="button" className="inline-flex items-center rounded-lg transition-all duration-200 bg-blue-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4  focus:ring-primary-300">
